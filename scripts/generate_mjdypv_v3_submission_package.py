...
def build_cover_letter() -> Path:
    ...
    body = [
        ...
        "The manuscript presents a deterministic transcriptomic prioritization framework together with a stricter statistical layer, including random-effects meta-analysis, confidence intervals, heterogeneity metrics, and explicit evidence-tier grading.",
...
def build_response_letter() -> Path:
    rows = [
        ("Overall assessment: The manuscript read more like a concept paper than a rigorous computational study.", "We rebuilt the manuscript around a reproducible computational workflow and rewrote the paper in full journal style. The final version now contains explicit study aims, structured methods, a data-linked results narrative, clearer discussion of uncertainty, and a more restrained translational interpretation.", "Abstract paras 4-8; Introduction paras 12-15; Methods paras 17-28; Results paras 30-42; Discussion paras 55-59"),
        ("Major weakness: Methodology transparency is insufficient.", "Addressed. We now describe dataset sourcing, within-cohort processing, handling of platform differences, probe-to-gene mapping, log transformation, differential-expression analysis, deterministic prioritization, random-effects meta-analysis, and evidence-tier assignment. The supplementary file was also reformatted to show both summary and cohort-specific evidence tables.", "Methods paras 17-28; Supplementary Tables S1-S7"),
        ("Major weakness: Gene signature derivation is unclear and potentially biased.", "Addressed. We clarified that the 50 genes are not presented as a de novo KFD discovery signature. They are now explicitly described as a prespecified mechanistic host-response panel spanning cytokine, interferon, endothelial, coagulation, platelet, oxidative-stress, and neurological/barrier biology, with Reactome-informed pathway grouping.", "Abstract para 6; Introduction para 15; Methods paras 23-25; Supplementary Tables S2-S3"),
        ("Major weakness: Composite scoring system appears arbitrary.", "Addressed. We retained the deterministic prioritization layer but defined its components clearly and added an independent random-effects meta-analytic layer so that mechanistic prioritization can be separated from pooled transcriptomic evidence. This makes the ranking more transparent and less dependent on one score alone.", "Abstract para 6; Methods paras 23-28; Results paras 34-36; Supplementary Tables S2-S7"),
        ("Major weakness: Results and Discussion partially overstate clinical applicability.", "Addressed. We removed treatment-style recommendations and now describe all shortlisted agents as hypothesis-generating candidates or supportive-care-aligned options requiring further preclinical or clinical validation.", "Abstract paras 7-8; Results paras 40-42; Discussion paras 57-59; Conclusions para 63"),
        ("Major weakness: Some citations do not actually support the statements.", "Addressed. The bibliography was rebuilt around KFD epidemiology, GEO, dengue cohorts, Reactome, ChEMBL, host-directed therapy, dengue vascular biology, hemorrhage evidence, and KFD healthcare-seeking literature. Irrelevant references from earlier drafts were removed and in-text citation flow was corrected.", "Introduction paras 12-15; Methods paras 18, 21, 24-25; Discussion paras 56-59; References paras 66-84"),
        ("Major weakness: Tables and results sections are inconsistent with text claims.", "Addressed. The results narrative was rewritten so that pathway interpretation and translational ranking match the underlying summary tables. Cytokine signaling is now explicitly described as the strongest pathway-level signal, while endothelial and coagulation findings are retained as mechanistic priorities with weaker transcriptomic support.", "Results paras 34-42; Tables 1-3 at paras 43-45; Figures 1-4 at paras 46-52"),
        ("Major Comment 1. Lack of clarity in gene signature derivation.", "Addressed comprehensively. We now explain preprocessing, how platform differences were handled, that within-cohort differential-expression analysis was performed, what statistics were retained, and that the 50 genes represent a prespecified mechanistic panel rather than an intersection or union derived directly from the analyzed cohorts.", "Methods paras 17-28; Supplementary Methods paras 2-5; Supplementary Tables S2-S3"),
        ("Major Comment 2. Composite scoring system is insufficiently defined.", "Addressed comprehensively. The manuscript now explains the deterministic prioritization dimensions, notes the translational role of tractability information, and adds a separate random-effects meta-analysis with confidence intervals, pooled P values, and I-squared. This revised structure lets readers judge transcriptomic support and mechanistic relevance independently.", "Methods paras 23-28; Results paras 34-42; Supplementary Tables S2-S7"),
        ("Major Comment 3. Overstatement of the 'multi-omics' approach.", "Addressed. We removed the unsupported multi-omics framing from the title and manuscript text. The final title and body consistently describe the study as a transcriptomic evidence and mechanistic prioritization framework.", "Title para 0; Abstract paras 4-8; Introduction paras 13-15; Conclusions para 63"),
        ("Major Comment 4. Inconsistency between results and interpretation.", "Addressed. The narrative now states that inflammatory pathways carry the strongest transcriptomic support and that cytokine signaling has the highest pathway-level signal in the deterministic framework. Endothelial and coagulation pathways are discussed as clinically important but transcriptomically weaker categories under current data.", "Results paras 37-42; Discussion paras 55-59"),
        ("Major Comment 5. Clinical recommendations appear premature.", "Addressed. Atorvastatin, tranexamic acid, and N-acetylcysteine are now framed as staged translational or preclinical priorities rather than district-hospital treatment recommendations. The paper now explicitly states that the shortlist is hypothesis-generating only.", "Results para 42; Discussion paras 58-59; Table 3 para 45; Conclusions para 63"),
        ("Major Comment 6. Cross-virus extrapolation requires stronger justification.", "Addressed. We narrowed the discovery base to three human dengue severity cohorts, justified their use as the most accessible severe-flaviviral proxy datasets, and explicitly discuss uncertainty related to virus-specific biology, tissue context, and stage of disease.", "Introduction paras 14-15; Methods paras 17-19; Results paras 31-34; Limitations para 61"),
        ("Minor Comment 1. Title accuracy.", "Addressed. The title no longer refers to a multi-omics pipeline and now accurately reflects the final study design.", "Title para 0"),
        ("Minor Comment 2. Abstract clarity.", "Addressed. The abstract no longer implies that a KFD-specific host signature was discovered. It now states that a prespecified host-response panel was evaluated using proxy flaviviral data and strengthened with meta-analysis.", "Abstract paras 4-8"),
        ("Minor Comment 3. Reference relevance.", "Addressed. Irrelevant references from earlier drafts were removed. The final reference list is aligned with statements on KFD epidemiology, GEO resources, dengue discovery cohorts, pathway ontology, tractability resources, vascular biology, hemorrhage evidence, and KFD healthcare context.", "References paras 66-84; Introduction and Discussion citations throughout"),
        ("Minor Comment 4. Pathway classification.", "Addressed. The pathway framework is now explicitly described as Reactome-informed, and the categorized panel is documented in the methods and supplementary materials.", "Introduction para 15; Methods para 24; Supplementary Tables S2-S3"),
        ("Minor Comment 5. Drug candidate table and vitamin K rationale.", "Addressed. Vitamin K is no longer presented as a high-priority therapy. The intervention shortlist was rebuilt around supportive-care aligned measures and exploratory host-directed candidates with clearer mechanistic rationale.", "Results paras 40-42; Table 3 para 45"),
        ("Minor Comment 6. Figure descriptions.", "Addressed. The figures were regenerated with correct numbering, publication-facing titles, axis labels, and descriptive captions. Figure 1 shows sample counts; Figure 2 shows meta-priority ranking; Figure 3 shows pathway effect size versus heterogeneity; and Figure 4 shows the original composite ranking for comparison.", "Figures 1-4 at paras 46-52; separate figures file"),
        ("Strength noted by reviewer: neglected tropical disease focus and repurposable drugs accessible in endemic settings.", "We preserved this strength while improving restraint. The final manuscript still emphasizes low-cost, translationally realistic interventions, but now frames them appropriately as investigational priorities rather than care recommendations.", "Introduction paras 12-13; Discussion paras 58-59"),
        ("Limitations to emphasize: cross-virus heterogeneity, absence of KFD-specific transcriptomic data, tissue-specific differences, lack of experimental validation.", "Addressed. These limitations are now stated explicitly in the introduction, results interpretation, limitations section, discussion, and conclusion. The final manuscript clearly states that the framework supports prioritization under uncertainty rather than therapeutic validation.", "Introduction para 14; Results paras 31-34, 39-42; Limitations para 61; Conclusions para 63"),
    ]
    doc = Document()
    set_margins(doc)
    ...
    doc.add_paragraph(
        "All major and minor comments have been addressed. Manuscript locations below refer to paragraph numbers in the final blinded manuscript DOCX. Exact page and line numbers are not extracted reliably from DOCX files in this environment, so paragraph references are provided instead."
    )
    table = doc.add_table(rows=len(rows) + 1, cols=3)
    table.style = "Table Grid"
    headers = ["Reviewer Comment", "Response", "Location in Final Blinded Manuscript"]
